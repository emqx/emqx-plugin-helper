...
-record(message, {
    ...
    from :: atom() | binary(),
    %% Message flags
    flags = #{} :: emqx_plugin_helper_types:flags(),
    ...
    headers = #{} :: emqx_plugin_helper_types:headers(),
    %% Topic that the message is published to
    topic :: emqx_plugin_helper_types:topic(),
    %% Message Payload
    payload :: emqx_plugin_helper_types:payload(),
